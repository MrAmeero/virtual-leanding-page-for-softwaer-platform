            ...
            <div key={index} className='w-full sm:w-1/2 lg:w-1/3 p-2'>
                ...
                '>
                    ...
                    <ul>
                        ...
                        <a href='#' className='inline-flex justify-center items-center text-center w-full h-12 tracking-wide text-xl hover:bg-orange-500 border border-orange-900 rounded-lg transition duration-200 mt-20'>Subscribe</a>
                    </ul>
                </div>
